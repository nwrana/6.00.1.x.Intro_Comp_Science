...
file_name = 'C:\Users\w15psnnw\Documents\6. Personal\MOOC\Intro to Comp Sci using Python\Week 5\words.txt'
...
WORDLIST_FILENAME = "C:/Users/w15psnnw/Documents/6. Personal/MOOC/Intro to Comp Sci using Python/Week 5/words.txt"
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in lowerShift.values():
            lowerLetterShift = lowerNorm.keys()[lowerNorm.values()[i]]
            lowerLetterNorm = lowerShift.keys()[lowerShift.values()[i]]
        ...
        for i in upperShift.values():
            upperLetterShift = upperNorm.keys()[upperNorm.values()[i]]
            upperLetterNorm = upperShift.keys()[upperShift.values()[i]]
    ...
    def apply_shift(self, shift):
        ...
        return ''.join(cipherText) #collapses list into a string for easy viewing
